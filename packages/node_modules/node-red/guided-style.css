@font-face {
    ...
    src: url("/red/font/Manrope-Bold.woff");
}

@font-face {
    font-family: ManropeRegular;
    src: url("/red/font/Manrope-Regular.woff");
}

@font-face {
    font-family: Poppins;
    src: url("/red/font/Poppins.woff");
}
...
.red-ui-deploy-button-group {
    background-color: rgb(1, 91, 187) !important;
...
#red-ui-palette {
    width: 220px;
    background: linear-gradient(to top, rgb(255, 255, 255, 0) 0%, rgb(248, 249, 250) 100%) !important;
    border-radius: 5px;
}
...
.red-ui-tabs ul li:not(.active) a:hover+.red-ui-tabs-fade {
    width: 55px;
    background-image: linear-gradient(to right, rgb(240, 240, 240, 0.001) 30%, #f5f6f7 70%);
}
...
.red-ui-tabs.red-ui-tabs-add.red-ui-tabs-menu.red-ui-tabs-scrollable>.red-ui-tab-button.red-ui-tabs-add>a {
    background-image: url(/red/pic/add-icon.png);
...
.red-ui-tabs.red-ui-tabs-add.red-ui-tabs-menu.red-ui-tabs-scrollable>.red-ui-tab-button.red-ui-tabs-menu>a {
    background-image: url(/red/pic/down-arrow-icon.png);
    background-size: 22px;
    background-repeat: no-repeat;
    margin-top: 7px;
}
...
.comment-node~g.red-ui-flow-node-icon-group>image,
...
.comment-node~image,
.comment-node~.red-ui-flow-node-input-label,
.comment-node~.red-ui-flow-node-output-label,
.debug-node~image,
...
.status-node~.red-ui-flow-node-intput-icon,
.status-node~.red-ui-flow-node-input-label,
.catch-node~.red-ui-flow-node-intput-icon,
.catch-node~.red-ui-flow-node-input-label,
.complete-node~.red-ui-flow-node-intput-icon,
.complete-node~.red-ui-flow-node-input-label {
    display: none;
}
...
g.red-ui-flow-node-selected>g>path.red-ui-flow-node-icon-shade {
    fill: rgb(201 235 248) !important;
...
/* .node-with-status>rect.comment-node {
    height: 85px;
} */

/* .node-with-status>rect.comment-node+g.red-ui-flow-node-icon-group>rect {
    height: 83px;
}

.node-with-status>rect.comment-node+g.red-ui-flow-node-icon-group>image {
    transform: translate(0, 14px);
}

.node-with-status>rect.comment-node~g.red-ui-flow-node-status-group {
    transform: translate(59px, 60px);
} */
...
.flows-button {
    ...
    border: unset !important;
    color: #015bbb !important;
    background-color: rgb(229 248 240) !important;
    padding: 0.765rem 1.125rem !important;
    border-radius: 4px;
    font-size: 0.875rem;
    font-weight: 700;
    font-family: 'ManropeRegular';
...
input#search-flows {
    ...
    margin: 0 5% 7% 5%;
    color: #6c757d !important;
    background-image: url(/red/pic/loupe.png) !important;
...
div.red-ui-palette-node:hover>.red-ui-palette-icon-container>div {
    filter: unset;
}
